...
import net.mcreator.legendaryweapons.procedures.MagicalroseMobplayerCollidesWithPlantProcedure;
...
public class MagicalroseBlock extends LegendaryWeaponsModElements.ModElement {
	@ObjectHolder("legendary_weapons:magicalrose")
	public static final Block block = null;
	public MagicalroseBlock(LegendaryWeaponsModElements instance) {
		super(instance, 71);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public void onEntityCollision(BlockState state, World world, BlockPos pos, Entity entity) {
			...
			int z = pos.getZ();
			{
				...
				MagicalroseMobplayerCollidesWithPlantProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
