...
public class ArcherEntity extends LegendaryWeaponsModElements.ModElement {
	public static EntityType entity = null;
	@ObjectHolder("legendary_weapons:entitybulletarcher")
	public static final EntityType arrow = null;
	public ArcherEntity(LegendaryWeaponsModElements instance) {
		super(instance, 66);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("archer")
						.setRegistryName("archer");
		elements.entities.add(() -> entity);
		elements.items
				.add(() -> new SpawnEggItem(entity, -12171706, -9352178, new Item.Properties().group(LegendItemGroup.tab)).setRegistryName("archer"));
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
				.size(0.5f, 0.5f)).build("entitybulletarcher").setRegistryName("entitybulletarcher"));
	}
	...
	public static class CustomEntity extends TameableEntity implements IRangedAttackMob {
		...
		protected void registerGoals() {
			super.registerGoals();
			this.targetSelector.addGoal(1, new NearestAttackableTargetGoal(this, PillagerEntity.class, false, false));
			this.targetSelector.addGoal(2, new NearestAttackableTargetGoal(this, VindicatorEntity.class, false, false));
			this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, EvokerEntity.class, false, false));
