...
public class GemItem extends LegendaryWeaponsModElements.ModElement {
	@ObjectHolder("legendary_weapons:gem")
	public static final Item block = null;
	public GemItem(LegendaryWeaponsModElements instance) {
		super(instance, 13);
	}
