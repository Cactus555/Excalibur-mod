...
public class AutelStructure extends LegendaryWeaponsModElements.ModElement {
	public AutelStructure(LegendaryWeaponsModElements instance) {
		super(instance, 64);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 20000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("legendary_weapons", "autel"));
						if (template == null)
							return false;
