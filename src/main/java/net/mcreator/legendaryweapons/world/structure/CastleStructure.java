...
package net.mcreator.legendaryweapons.world.structure;
...
public class CastleStructure extends LegendaryWeaponsModElements.ModElement {
	public CastleStructure(LegendaryWeaponsModElements instance) {
		super(instance, 67);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 3000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("legendary_weapons", "tower"));
						if (template == null)
							return false;
